            ...
            if (mysqli_num_rows($outExiste) == 0) {
                ...
                <div id='docrearoferta_error' class='container error text-white'>
                    ...
                    <div class='row justify-content-center mt-4 mb-4'>
                        <div class='col-auto'>
                            <div style='background: rgba(0, 0, 0,0.5); border: 1px solid #212529; border-radius: 0.25rem;'>
            ...
            <div class="row justify-content-center mt-4 mb-4">
                 <div class="col-auto">
                    ...
                    <p class="text-center">¿Qué deseas hacer a continuación?</p>
                     ...
                     <?php echo "<input type='button' class='binput2 mt-3' onclick=location.href='viewOferta.php?id=$id_oferta' value='Más información'>";?>
