...
<body>
    ...
    <div id="dologout_success">
        ...
        <h5 class="volver">¡Hasta pronto <?php echo $datosUser['username'] ?>!<p>Has cerrado sesión correctamente. </h5><h5><a href="index.php" class="volver">Volver al inicio</a></h5></h5>
    </div>
    <?php
