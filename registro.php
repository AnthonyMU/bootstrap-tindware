        ...
        <div class="col-md-6 col-sm-8 col-lg-6 col-lg-5 formulario">
            <form action="do_registro.php" method="POST">
                    ...
                    <div class="form-group mx-sm-4 pb-3">
                        ...
                        <p class="l lead"> Latitud: <input type="text" size="5" onkeydown="return false;" style="pointer-events: none;" id="lat" name="lat" required value=""/><p>
                        <p class="l lead">Longitud: <input type="text" size="5" onkeydown="return false;" style="pointer-events: none;" name="lon" id="lon" required value=""/></p>
                    </div>
                    <div class="form-group mx-sm-4 pb-3">
